...
const Quiz = ({ questions, setIsEnd, lessonSettings, isPlayingUser, setIsPlayingUser }: any) => {
  ...
  const handleAnswerClick = (answerIndex: number, field: any) => {
    ...
    if (isPlayingUser) {
      setIsPlayingUser({
        ...
        incorrect: !isCorrect ? isPlayingUser.incorrect + 1 : isPlayingUser.incorrect,
        selectedAnswers: [
    ...
    setTimeout(() => {
      ...
      if (currentQuestionIndex < questions.length - 1) {
        ...
        setIsEnd(true); // Завершение викторины
      }
    }, 1500);
  };
