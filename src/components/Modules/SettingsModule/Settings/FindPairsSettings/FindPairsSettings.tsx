import m from './FindPairsSettings.module.scss';
...
import FindPairsSection from '../../Section/FindPairsSection/FindPairsSection';

const FindPairsSettings = ({ lessonSlug, userData }: any) => {
  const {
    data,
    saveLessonSettings,
    uploadMusicFile,
...
export default FindPairsSettings;