import m from './UnjumbleSettings.module.scss';
...
import UnjumbleSection from '../../Section/UnjumbleSection/UnjumbleSection';

const UnjumbleSettings = ({ lessonSlug, userData }: any) => {
  const {
    data,
    saveLessonSettings,
    uploadMusicFile,
...
export default UnjumbleSettings;