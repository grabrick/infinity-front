import m from './CrosswordSettings.module.scss';
...
import CrosswordSection from '../../Section/CrosswordSection/CrosswordSection';

const CrosswordSettings = ({ lessonSlug, userData }: any) => {
  const {
    data,
    saveLessonSettings,
    uploadMusicFile,
