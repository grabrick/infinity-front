...
import m from './MatchUpFields.module.scss';
...
const MatchUpFields = ({ selectedLesson, setIsOpenEditor }: any) => {
      ...
      >
        ...
        >
          <Header
            ...
            isLimit={{ isActive: true, createLimitCount: 40, formState: formState }}
